...
<!-- Link to related issues, stories, or cross-module requests -->
<!-- Example: Closes #123, Implements story-2-1-event-backbone -->
...
- [ ] `platform/ts-schema` - Shared types and schemas
...
<!-- Complete this section if your PR touches multiple modules -->
...
- [ ] I have reviewed changes from each module's perspective
