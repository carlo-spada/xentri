...
> Strategy & Clarity Engine - where business clarity begins.

The Strategy category contains modules that help businesses define their identity, goals, and strategic direction. This is the entry point for new Xentri users - conversation before configuration.
...
- Updates the Brief as the business evolves
...
This category is the focus of **Epic 2** in the product roadmap.
