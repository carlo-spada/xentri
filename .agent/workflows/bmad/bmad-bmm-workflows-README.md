...
- Path: `.bmad/bmm/workflows/3-solutioning/amend-epics/workflow.yaml`
- Amend Epics with impact analysis. Routes to system or domain amendment workflow based on entity type.

**validate-epics**

- Path: `.bmad/bmm/workflows/3-solutioning/validate-epics/workflow.yaml`
- Validate Epics for traceability, coverage, and BMAD compliance. Routes to system or domain validation based on entity type.
